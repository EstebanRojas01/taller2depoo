...
public class SandboxConjuntos
{
    ...
    {
        List<String> orden = new ArrayList<>(arbolCadenas);
        return orden;
    }
    ...
    {
        NavigableSet<String> revez = arbolCadenas.descendingSet();
        List<String> listaCadenas = new ArrayList<>(revez);
        return listaCadenas;
    }
     ...
     */
    public void agregarCadena( String cadena ) {arbolCadenas.add(cadena);}

    /**
     * Elimina una cadena del conjunto de cadenas
     * @param cadena La cadena que se va eliminar
     */
    public void eliminarCadena( String cadena ) {arbolCadenas.remove(cadena);}
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	arbolCadenas.removeIf(variable -> variable.toLowerCase().equals(cadMin));
    }
    ...
    {
    	NavigableSet<String> gritando = new TreeSet<>();
        for (String cadena : arbolCadenas) {
        	gritando.add(cadena.toUpperCase()); 
        }
        arbolCadenas = gritando;
    }
    ...
    {
    	TreeSet<String> cadena = (TreeSet<String>) arbolCadenas;
    	TreeSet<String> MasAMenos = (TreeSet<String>) cadena.descendingSet();
        return MasAMenos;
    }
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
        for (String cadena : otroArreglo) {
    		if(!arbolCadenas.contains(cadena)) {return false;}}
        return true;
    }
